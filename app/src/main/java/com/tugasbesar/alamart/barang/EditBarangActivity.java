...
public class EditBarangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Gson gson = new Gson();
        requestBarang = gson.fromJson(requestBarangJson, Barang.class);
        ...
        etKeterangan.setText(requestBarang.getDeskripsi());
    ...
    private void saveBarang() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, AlamartAPI.BARANG_API + "/" + requestBarang.getId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getString("success").equals("true")) {
                        Toast.makeText(EditBarangActivity.this, obj.getString("message"), Toast.LENGTH_SHORT)
                                .show();
                        onBackPressed();
                    }
