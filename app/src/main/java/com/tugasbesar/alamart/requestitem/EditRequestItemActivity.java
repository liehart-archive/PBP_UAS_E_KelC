...
public class EditRequestItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_request_item);

        progressDialog = new ProgressDialog(this);

        String requestBarangJson = getIntent().getStringExtra("item");
        Gson gson = new Gson();
        requestBarang = gson.fromJson(requestBarangJson, RequestBarang.class);
        ...
        etNama.setText(requestBarang.getNama());
        etHarga.setText(String.valueOf(requestBarang.getHarga()));
        etKeterangan.setText(requestBarang.getKeterangan());
    ...
    private void saveBarang() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, AlamartAPI.REQUEST_API + "/" + requestBarang.getId(), new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getString("success").equals("true")) {
                        Toast.makeText(EditRequestItemActivity.this, obj.getString("message"), Toast.LENGTH_SHORT)
                                .show();
                        onBackPressed();
                    }
